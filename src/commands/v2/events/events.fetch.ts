 ...
 */
export interface V2EventsFetchEventsInput {
  /** the tenant id */
  tenantId: string
  /** the data core id */
  dataCoreId: string
 ...
 */
export interface V2EventsFetchEventsOutput {
  /** the time buckets */
  timeBuckets: string[]
 ...
 */
export class V2EventsFetchCommand extends Command<V2EventsFetchEventsInput, V2EventsFetchEventsOutput> {
  /**
   ...
   * Parse the response
   */
  protected override parseResponse(rawResponse: unknown): V2EventsFetchEventsOutput {
